...
var expect = require("expect.js"),
    ...
    validateUser = require("../lib/auth/user-validator"),
    authStorage;
...
describe("AuthStorage", function() {
    ...
    it("is defined", function() {
        ...
        expect(validateUser).to.be.a("function");
    });
        ...
        function checkValue(value) {
            return function(done) {
                validateUser(value, null, function(result) {
                    expect(result.errors.globals).to.be.equal("User should be an object!");
                    done();
                });
    ...
    function checkField(field, value, expected) {
        return function(done) {
            ...
            validateUser(user, authStorage, function(result) {
                expect(result.errors[field]).to.be.equal(expected);
                done();
            });
    ...
    describe("Well formed user", function() {
        ...
        it("errors are empty", function() {
        	expect(results.errors).to.be.equal(undefined);
        })
    })
});
