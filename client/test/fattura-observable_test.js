...
describe("Observable", function() {
    ...
    describe("ObservableFattura", function() {
        ...
        it("emit changed event for imponibile, totale and iva on quantita riga changed", function() {
            results = [];
        ...
        it("emit changed event for imponibile, totale and iva on prezzoCadauno riga changed", function() {
        ...
        it("emit changed event for imponibile, totale and iva on riga added", function() {
        ...
        it("emit changed event for imponibile, totale and iva on riga removed", function() {
